...
#The build 
	...
	make -C $(pwd) O=output msm8916_sec_defconfig VARIANT_DEFCONFIG=a3fu_defconfig SELINUX_DEFCONFIG=selinux_defconfig
...
#Ramdisk packing
	...
	cp -r hK-tools/ramdisk/A3FU/* hK-out/pack/rd
...
#Auto made zips for FU only - now
